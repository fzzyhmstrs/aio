...
class CornucopiaAugment(tier: Int, maxLvl: Int, vararg slot: EquipmentSlot): MiscAugment(tier,maxLvl, *slot) {

    override val baseEffect: AugmentEffect
        get() = super.baseEffect.withRange(3.0,2.0).withDamage(0.15F,0.05F)
    ...
    override fun augmentStat(imbueLevel: Int): AugmentDatapoint {
        return AugmentDatapoint(SpellType.GRACE,12,12,12,imbueLevel, LoreTier.HIGH_TIER, Items.DRIED_KELP_BLOCK)
    }
