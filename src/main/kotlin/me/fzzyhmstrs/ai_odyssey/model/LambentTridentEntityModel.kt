...
class LambentTridentEntityModel(private val root: ModelPart) : TridentEntityModel(root) {


    companion object {
        var TEXTURE: Identifier = Identifier(AIO.MOD_ID,"textures/entity/lambent_trident.png")
