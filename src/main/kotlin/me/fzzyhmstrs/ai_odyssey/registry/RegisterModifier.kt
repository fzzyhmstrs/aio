...
object RegisterModifier {
    ...
    val ENDURING = AugmentModifier(Identifier(AI.MOD_ID,"reach")).withDescendant(GREATER_ENDURING).withDuration(durationPercent = 15).also { regMod.add(it) }
    val LESSER_ENDURING = AugmentModifier(Identifier(AI.MOD_ID,"lesser_reach")).withDescendant(ENDURING).withDuration(durationPercent = 10).also { regMod.add(it) }
