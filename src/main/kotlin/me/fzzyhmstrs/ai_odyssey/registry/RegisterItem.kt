...
import me.fzzyhmstrs.ai_odyssey.item.BookOfLegendItem
import me.fzzyhmstrs.ai_odyssey.item.CustomScepterItem
...
object RegisterItem {
    ...
    val REDEMPTION = CustomScepterItem(ScepterLvl3ToolMaterial,FabricItemSettings().group(ItemGroup.COMBAT).rarity(Rarity.EPIC),
        listOf(),
        listOf(RegisterModifier.HEALERS_PACT,RegisterModifier.HEALERS_GRACE, RegisterModifierAI.GREATER_THRIFTY, RegisterModifierAI.GREATER_ATTUNED)
    ...
    val SPITE_OF_THE_BLOOD_WITCH = CustomScepterItem(ScepterLvl3ToolMaterial,FabricItemSettings().group(ItemGroup.COMBAT).rarity(Rarity.EPIC),
        listOf(),
        listOf(RegisterModifier.BLOOD_PACT, RegisterModifierAI.GREATER_ATTUNED, RegisterModifier.GREATER_ENDURING, RegisterModifier.FURIOUS)
    ...
    val BOOK_OF_LEGEND = BookOfLegendItem(FabricItemSettings().group(ItemGroup.MISC).rarity(Rarity.EPIC),"book_of_legend",true).also{ regItem["resplendent_rarity"] = it}
