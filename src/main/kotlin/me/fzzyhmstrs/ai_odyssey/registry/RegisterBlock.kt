...
object RegisterBlock {
    ...
    //imbued deepslate
    val IMBUED_DEEPSLATE_MESSAGE = ImbuedDeepslateMessageBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_SPLATTER = ImbuedDeepslateSplatterBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE = ImbuedBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_COBBLED = ImbuedBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_POLISHED = ImbuedBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_BRICKS = ImbuedBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_BRICKS_CRACKED = ImbuedBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_CHISELED = ImbuedBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_TILES = ImbuedBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_TILES_CRACKED = ImbuedBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_WALL_COBBLED = ImbuedDeepslateWallBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_WALL_POLISHED = ImbuedDeepslateWallBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_WALL_BRICK = ImbuedDeepslateWallBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_WALL_TILE = ImbuedDeepslateWallBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_STAIRS_COBBLED = ImbuedDeepslateStairsBlock(IMBUED_DEEPSLATE_COBBLED.defaultState,FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_STAIRS_POLISHED = ImbuedDeepslateStairsBlock(IMBUED_DEEPSLATE_POLISHED.defaultState,FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_STAIRS_BRICK = ImbuedDeepslateStairsBlock(IMBUED_DEEPSLATE_BRICKS.defaultState,FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_STAIRS_TILE = ImbuedDeepslateStairsBlock(IMBUED_DEEPSLATE_TILES.defaultState,FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_SLAB_COBBLED = ImbuedDeepslateSlabBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_SLAB_POLISHED = ImbuedDeepslateSlabBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_SLAB_BRICK = ImbuedDeepslateSlabBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_SLAB_TILE = ImbuedDeepslateSlabBlock(FabricBlockSettings.of(Material.STONE).strength(5000F,3600000.0f),3.5f)
    val IMBUED_GLASS = ImbuedBlock(FabricBlockSettings.of(Material.GLASS).strength(5000F,3600000.0f)
        .allowsSpawning { _: BlockState, _: BlockView, _: BlockPos, _: EntityType<*> -> never() }
        .blockVision { _, _, _ ->  never()}
        .suffocates { _, _, _ -> never() },0.3f)
