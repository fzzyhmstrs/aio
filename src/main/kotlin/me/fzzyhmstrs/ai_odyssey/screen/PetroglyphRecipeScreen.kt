...
class PetroglyphRecipeScreen(handler: PetroglyphRecipeScreenHandler, playerInventory: PlayerInventory, title: Text):
    ...
    private val texture = Identifier(AIO.MOD_ID,"textures/gui/container/recipe_screen_gui.png")
    ...
    override fun render(matrices: MatrixStack, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        if (indexes != null){
            ...
            if (PetroglyphRecipeBlock.recipeMap.containsKey(id)){
                val tooltipText = LiteralText(PetroglyphRecipeBlock.recipeMap[id]?.name?:"")
