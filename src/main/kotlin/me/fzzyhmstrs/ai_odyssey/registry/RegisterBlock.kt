...
object RegisterBlock {
    ...
    val CRYSTALLINE_SWITCH = CrystallineSwitchBlock(FabricBlockSettings.of(Material.AMETHYST, MapColor.PINK).sounds(BlockSoundGroup.AMETHYST_BLOCK).requiresTool().strength(500.0f, 1200.0f).luminance { state: BlockState ->
    ...
    val HARD_LIGHT_BARRIER = HardLightBarrierBlock(FabricBlockSettings.of(Material.GLASS).strength(-1.0F,3600000.0f).dropsNothing().nonOpaque()
    ...
    //imbued deepslate
    val IMBUED_DEEPSLATE_MESSAGE = ImbuedDeepslateMessageBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE_TILES).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_SPLATTER = ImbuedDeepslateSplatterBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE_TILES).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE = ImbuedBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_COBBLED = ImbuedBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_POLISHED = ImbuedBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_BRICKS = ImbuedBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE_BRICKS).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_BRICKS_CRACKED = ImbuedBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE_BRICKS).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_CHISELED = ImbuedBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_TILES = ImbuedBlock(FabricBlockSettings.of(Material.STONE).requiresTool().sounds(BlockSoundGroup.DEEPSLATE_TILES).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_TILES_CRACKED = ImbuedBlock(FabricBlockSettings.of(Material.STONE).requiresTool().sounds(BlockSoundGroup.DEEPSLATE_TILES).strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_WALL_COBBLED = ImbuedDeepslateWallBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_WALL_POLISHED = ImbuedDeepslateWallBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_WALL_BRICK = ImbuedDeepslateWallBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE_BRICKS).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_WALL_TILE = ImbuedDeepslateWallBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE_TILES).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_STAIRS_COBBLED = ImbuedDeepslateStairsBlock(IMBUED_DEEPSLATE_COBBLED.defaultState,FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_STAIRS_POLISHED = ImbuedDeepslateStairsBlock(IMBUED_DEEPSLATE_POLISHED.defaultState,FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_STAIRS_BRICK = ImbuedDeepslateStairsBlock(IMBUED_DEEPSLATE_BRICKS.defaultState,FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE_BRICKS).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_STAIRS_TILE = ImbuedDeepslateStairsBlock(IMBUED_DEEPSLATE_TILES.defaultState,FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE_TILES).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_SLAB_COBBLED = ImbuedDeepslateSlabBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_SLAB_POLISHED = ImbuedDeepslateSlabBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_SLAB_BRICK = ImbuedDeepslateSlabBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE_BRICKS).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_DEEPSLATE_SLAB_TILE = ImbuedDeepslateSlabBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.DEEPSLATE_TILES).requiresTool().strength(5000F,3600000.0f),3.5f)
    val IMBUED_GLASS = ImbuedGlassBlock(FabricBlockSettings.of(Material.GLASS).requiresTool().nonOpaque().strength(5000F,3600000.0f)
        .allowsSpawning { _: BlockState, _: BlockView, _: BlockPos, _: EntityType<*> -> never() }
        .blockVision { _, _, _ ->  never()}
        .suffocates { _, _, _ -> never() }
        .solidBlock { _, _, _ -> never() },0.3f)
    ...
    fun registerAll(){
        ...
        registerBlockWithOtherItem("gargantuan_kelp_stem", GARGANTUAN_KELP_STEM)
        ...
        registerBlockWithOtherItem("gargantuan_skeletal_kelp_stem", GARGANTUAN_SKELETAL_KELP_STEM)
        ...
        registerBlock("imbued_glass", IMBUED_GLASS, ItemGroup.BUILDING_BLOCKS)
